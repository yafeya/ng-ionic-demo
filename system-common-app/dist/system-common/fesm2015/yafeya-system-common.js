 ...
 */
/** @type {?} */
const WindowSizeWatcherToken = new InjectionToken('./IWindowSizeWatcher');
 ...
 */
/** @type {?} */
const MessageMediatorToken = new InjectionToken('./message-mediator/IMessageMediator');
/** @type {?} */
const LoggerFactoryToken = new InjectionToken('./logging/ILoggerFactory');
/** @type {?} */
const ExceptionHandlerToken = new InjectionToken('./exception/IExceptionHandler');
/** @type {?} */
const CommandRepositoryToken = new InjectionToken('./command/ICommandRepository');
/** @type {?} */
const CommandDescriptorRepositoryToken = new InjectionToken('./command/ICommandDescriptorRepository');
/** @type {?} */
const ActionRepositoryToken = new InjectionToken('./action/IActionRepository');
 ...
 */
/** @type {?} */
const OptionRepositoryToken = new InjectionToken('./IOptionRepository');
 ...
 */
/** @type {?} */
const ComponentCreatorToken = new InjectionToken('./ICommponentCreator');
