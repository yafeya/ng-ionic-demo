(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs/Observable'), require('rxjs/add/operator/toPromise'), require('@angular/core'), require('@angular/http'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('yafeya-system-common', ['exports', 'rxjs/Observable', 'rxjs/add/operator/toPromise', '@angular/core', '@angular/http', '@angular/common'], factory) :
    (factory((global['yafeya-system-common'] = {}),global.rxjs.Observable,global.rxjs['add/operator/toPromise'],global.ng.core,global.ng.http,global.ng.common));
}(this, (function (exports,Observable,toPromise,core,http,common) { 'use strict';
    ...
    ***************************************************************************** */
     ...
     */
    /** @type {?} */
    var WindowSizeWatcherToken = new core.InjectionToken('./IWindowSizeWatcher');
     ...
     */
    /** @type {?} */
    var MessageMediatorToken = new core.InjectionToken('./message-mediator/IMessageMediator');
    /** @type {?} */
    var LoggerFactoryToken = new core.InjectionToken('./logging/ILoggerFactory');
    /** @type {?} */
    var ExceptionHandlerToken = new core.InjectionToken('./exception/IExceptionHandler');
    /** @type {?} */
    var CommandRepositoryToken = new core.InjectionToken('./command/ICommandRepository');
    /** @type {?} */
    var CommandDescriptorRepositoryToken = new core.InjectionToken('./command/ICommandDescriptorRepository');
    /** @type {?} */
    var ActionRepositoryToken = new core.InjectionToken('./action/IActionRepository');
    ...
    var InvokeCommandDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        InvokeCommandDirective.ctorParameters = function () {
            return [
                { type: undefined, decorators: [{ type: core.Inject, args: [CommandRepositoryToken,] }] },
                { type: undefined, decorators: [{ type: core.Inject, args: [LoggerFactoryToken,] }] }
            ];
        };
        InvokeCommandDirective.propDecorators = {
            CommandName: [{ type: core.Input, args: ['InvokeCommand',] }],
            CommandParam: [{ type: core.Input }],
            OnClicked: [{ type: core.HostListener, args: ['click', ['$event'],] }]
        };
     ...
     */
    /** @type {?} */
    var OptionRepositoryToken = new core.InjectionToken('./IOptionRepository');
    ...
    var LoggingExceptionHandler = /** @class */ (function () {
        ...
        /** @nocollapse */
        LoggingExceptionHandler.ctorParameters = function () {
            return [
                { type: undefined, decorators: [{ type: core.Inject, args: [LoggerFactoryToken,] }] }
            ];
        };
    ...
    var HttpClient = /** @class */ (function () {
        function HttpClient(http$$1, exceptionHandler, loggerFactory) {
            this.http = http$$1;
    ...
    var AngularServiceProvider = /** @class */ (function () {
        ...
        /** @nocollapse */
        AngularServiceProvider.ctorParameters = function () {
            return [
                { type: core.Injector }
            ];
        };
     ...
     */
    /** @type {?} */
    var ComponentCreatorToken = new core.InjectionToken('./ICommponentCreator');
    ...
    var SystemModule = /** @class */ (function () {
        ...
        SystemModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [common.CommonModule, http.HttpModule, http.JsonpModule],
                        providers: providers,
    ...
    exports.InvokeCommandDirective = InvokeCommandDirective;
    exports.CommandDescriptor = CommandDescriptor;
    exports.CommandDescriptorRepository = CommandDescriptorRepository;
    exports.CommandDescriptorExtensions = CommandDescriptorExtensions;
    exports.AppSettings = AppSettings;
    exports.AppSettingItem = AppSettingItem;
    exports.OptionRepositoryToken = OptionRepositoryToken;
    ...
    exports.DebugLoggerProvider = DebugLoggerProvider;
    exports.Log4JsLogger = Log4JsLogger;
    exports.Log4JsLoggerProvider = Log4JsLoggerProvider;
    exports.LoggerFactoryExtensions = LoggerFactoryExtensions;
    exports.LoggingExceptionHandler = LoggingExceptionHandler;
    ...
    exports.WindowSizeWatcherToken = WindowSizeWatcherToken;
    exports.WindowSizeWatcher = WindowSizeWatcher;
    exports.Collection = Collection;
    exports.Enumerable = Enumerable;
    exports.List = List;
    exports.Grouping = Grouping;
    exports.EnumerableIterator = EnumerableIterator;
    exports.NamedDictionary = NamedDictionary;
    ...
    exports.AngularServiceProvider = AngularServiceProvider;
    ...
    exports.MessageMediator = MessageMediator;
    exports.ComponentCreatorToken = ComponentCreatorToken;
    exports.ComponentCreator = ComponentCreator;
    exports.File = File;
    exports.Directory = Directory;
    exports.MessageMediatorToken = MessageMediatorToken;
    exports.LoggerFactoryToken = LoggerFactoryToken;
    exports.ExceptionHandlerToken = ExceptionHandlerToken;
    exports.CommandRepositoryToken = CommandRepositoryToken;
    exports.CommandDescriptorRepositoryToken = CommandDescriptorRepositoryToken;
    exports.ActionRepositoryToken = ActionRepositoryToken;
    exports.SystemModule = SystemModule;
    exports.ɵa = LoggerBase;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=yafeya-system-common.umd.js.map